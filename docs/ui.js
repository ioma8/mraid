...
document.querySelector('#relayoutBtn').onclick=()=>{const laidOut=layoutDiagram({direction,nodes,edges,subgraphs},currentViewCenter());nodes=laidOut.nodes;edges=laidOut.edges;subgraphs=laidOut.subgraphs;render();};
